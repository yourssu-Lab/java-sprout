...
import com.yourssu.roomescape.waiting.WaitingRequest;
import com.yourssu.roomescape.waiting.WaitingResponse;
...
public class MissionStepTest {
    ...
    void 육단계() {
        ...
        String status = myReservations.stream()
                .filter(it -> it.reservationId().equals(waiting.getId()))
